...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './aula.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AULA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AULA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AULA actions', async () => {
      const arg = { id: 11398 };
    ...
    it('dispatches UPDATE_AULA actions', async () => {
      const arg = { id: 11398 };
    ...
    it('dispatches PARTIAL_UPDATE_AULA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AULA actions', async () => {
      const arg = 42666;
