...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './inscricao.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSCRICAO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSCRICAO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSCRICAO actions', async () => {
      const arg = { id: 27284 };
    ...
    it('dispatches UPDATE_INSCRICAO actions', async () => {
      const arg = { id: 27284 };
    ...
    it('dispatches PARTIAL_UPDATE_INSCRICAO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSCRICAO actions', async () => {
      const arg = 42666;
